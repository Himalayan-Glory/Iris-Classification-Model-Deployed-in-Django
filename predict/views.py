...
import pandas as pd
from .models import Predict_Results
...
def predict_chances(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        Predict_Results.objects.create(sepal_length=sepal_length, sepal_width=sepal_width, petal_length=petal_length,
...
def view_results(request):
    ...
    data = {"dataset": Predict_Results.objects.all()}
